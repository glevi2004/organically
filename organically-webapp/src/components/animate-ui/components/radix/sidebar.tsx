...
function SidebarProvider({
  ...
  // Helper to toggle the sidebar - same behavior on all devices.
...
function Sidebar({
  ...
  // Removed mobile-specific Sheet behavior - use same sidebar for all screen sizes
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* This is what handles the sidebar gap on all screen sizes */}
      <div
