...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Organically - Instagram automation platform",
};

export default function TermsOfServicePage() {
  const lastUpdated = "December 10, 2024";
  const companyName = "Organically";
  const contactEmail = process.env.EMAIL_TERMS!;
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              {companyName} is a platform that provides Instagram automation
              tools, including:
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>
                Authorize us to access your Instagram account through
                Meta&apos;s official APIs
              </li>
              <li>
                Grant us permission to perform actions on your behalf (posting,
                commenting, messaging)
              </li>
              <li>
                Confirm you have the authority to connect the Instagram account
              </li>
              <li>
                Agree to comply with Instagram&apos;s Terms of Use and Community
                Guidelines
              </li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              ...
              <li>
                Automate activities in a way that violates Meta&apos;s Platform
                Policies
              </li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>
                All content you create, schedule, or publish through the Service
              </li>
              <li>
                Ensuring your content complies with applicable laws and platform
                policies
              </li>
              <li>
                Automated messages and responses configured in your workflows
              </li>
              <li>
                Obtaining necessary rights and permissions for content you
                upload
              </li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
              We do not monitor or review your content before publishing and are
              not liable for any content posted through your account.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              of content you create but grant us a license to use it as
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Instagram/Meta. Your use of these integrations is subject to the
              respective platforms&apos; terms of service. We are not
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              including changes to Instagram&apos;s API.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              {companyName.toUpperCase()} SHALL NOT BE LIABLE FOR:
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Terms or engage in conduct harmful to other users or the Service.
              You may terminate your account at any time by disconnecting your
              Instagram account and requesting account deletion.
            </p>
          </section>
